                      ...
                      columns: [
                        ...
                        GridColumn(
                            ...
                            label: Container(
                              alignment: Alignment.centerLeft,
                              child: Text(
                                  S.of(context).s_4h_chg.replaceFirst('4', '1'),
                                  style: Styles.tsSub_12(context)),
                            )),
                        GridColumn(
                            columnName: 'change4H',
                    ...
                    return Row(
                      children: [
                        ...
                        _FilterChip(
                            onTap: () async {
                              final result =
                                  await logic.openSelector(logic.exchangeItems);
                              if (result != null &&
                                  result.toLowerCase() !=
                                      logic.menuParamEntity.value.exchange
                                          ?.toLowerCase()) {
                                logic.menuParamEntity.value.exchange = result;
                                logic.updateChart();
                        ...
                        _FilterChip(
                            onTap: () async {
                              final result =
                                  await logic.openSelector(logic.intervalItems);
                              if (result != null &&
                                  result.toLowerCase() !=
                                      logic.menuParamEntity.value.interval
                                          ?.toLowerCase()) {
                                logic.menuParamEntity.value.interval = result;
                                logic.loadOIData();
                                logic.menuParamEntity.refresh();
                              }
                            },
