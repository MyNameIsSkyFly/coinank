...
import com.github.mikephil.charting.utils.MLog;
...
public class LineChartRenderer extends LineRadarRenderer {
    ...
    protected void drawLinear(Canvas c, ILineDataSet dataSet) {
        ...
        //MLog.d("range colors size:" + mXBounds.range + " " + dataSet.getColors().size() + " " + dataSet.getEntryCount());
        // more than 1 color
        if (dataSet.getColors().size() > 1) {
            ...
            for (int j = mXBounds.min; j < max; j++) {
                ...
                {
                    //by listen 20230413,解决多空比线条多颜色问题
                    //如果非多颜色模式，则走原始代码逻辑，作者原始代码在给line chart设计多颜色的时候，可能存在bug
                    if (!dataSet.isMulColorMode())
                    {
                        break;
                    }
                }
               ...
               // MLog.d("mul color :" + j + " #" + String.format("%x", dataSet.getColor(j)).substring(2, 8));
                //MLog.d("drawLines:" + mLineBuffer[0] + " " + mLineBuffer[1] + " " +
                //        mLineBuffer[2] + " " + mLineBuffer[3]);
            ...
            //MLog.d("info:" + mXBounds.min + " " + mXBounds.max + " " + mXBounds.range);
            if (e1 != null) {
                ...
                if (j > 0) {
                    ...
                    mRenderPaint.setColor(dataSet.getColor());
                     //MLog.d("drawLines:" + mLineBuffer[0] + " " + mLineBuffer[1] + " " +
                     //        mLineBuffer[2] + " " + mLineBuffer[3]);
                    //MLog.d("one color:" + String.format("%x", mRenderPaint.getColor()).substring(2, 8));
