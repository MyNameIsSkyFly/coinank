...
public class LimitLine extends ComponentBase {
    ...
    private String mExtLabel = "";
    private int mLabelBgColor = Color.rgb(0, 0, 0);

    public String getExtLabel() {
        return mExtLabel;
    }

    public void setExtLabel(String mExtLabel) {
        this.mExtLabel = mExtLabel;
    }
    ...
    public void setLabelBgColor(int mLabelBgColor) {
