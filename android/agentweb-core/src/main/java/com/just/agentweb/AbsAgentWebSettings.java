...
public abstract class AbsAgentWebSettings implements IAgentWebSettings, WebListenerManager {
    ...
    private void settings(WebView webView) {
        ...
        //mWebSettings.setAppCacheEnabled(true);//android 13 targetsdk 33没有些api了
        ...
        //mWebSettings.setAppCachePath(dir); android 13 targetsdk 33不支持
        //缓存文件最大值
        //mWebSettings.setAppCacheMaxSize(Long.MAX_VALUE);android 13 targetsdk 33不支持
        //新加的，android 13 targetsdk 33不支持setAppCacheMaxSize这些了
        mWebSettings.setCacheMode(WebSettings.LOAD_DEFAULT);
