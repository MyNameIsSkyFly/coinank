...
//        // 8.0 以上需要特殊处理
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
//            channelId = "4";//createNotificationChannel("4", "Floating Window");
//        } else {
//            channelId = "";
//        }
//
//        Intent nfIntent = new Intent(getApplicationContext(), FirstActivity.class);
...
//        Gson gson = new GsonBuilder().create();
//        symbolList = gson.fromJson(json, new TypeToken<List<SymbolVo>>() {}.getType());
//        if (symbolList == null)
