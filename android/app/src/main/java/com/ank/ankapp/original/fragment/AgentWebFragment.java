...
import com.ank.ankapp.original.client.MiddlewareChromeClient;
import com.ank.ankapp.original.client.MiddlewareWebViewClient;
import com.ank.ankapp.original.common.AndroidInterface;
import com.ank.ankapp.original.common.CommonWebChromeClient;
...
public class AgentWebFragment extends Fragment implements FragmentKeyDown {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_agentweb, container, false);
    ...
    {
        String url = "https://coinsoto.com/api/openInterest/chart?baseCoin=BTC&interval=1h&type=USD";
        OkHttpUtil.getJSON(url, new OkHttpUtil.OnDataListener() {
            ...
            public void onResponse(String url, Object obj,String json) {
                ...
                MLog.d("json:" + json.substring(0, 100));
                mAgentWeb.getJsAccessEntrace().quickCallJs("setChartData", json);
            }
...
//		return "http://ggzy.sqzwfw.gov.cn/WebBuilderDS/WebbuilderMIS/attach/downloadZtbAttach.jspx?attachGuid=af982055-3d76-4b00-b5ab-36dee1f90b11&appUrlFlag=sqztb&siteGuid=7eb5f7f1-9041-43ad-8e13-8fcb82ea831a";
    ...
    protected WebChromeClient mWebChromeClient = new WebChromeClient() {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            ...
            //MLog.d(TAG, "onProgressChanged:" + newProgress + "  view:" + view);
        }
    ...
    protected WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
            ...
            //MLog.d("onReceivedError:" + request.getUrl().toString()+ " " + error.getDescription()) ;
        ...
        public boolean shouldOverrideUrlLoading(final WebView view, String url) {
            MLog.d("mWebViewClient shouldOverrideUrlLoading:" + url);
           // Log.i(TAG, "view:" + new Gson().toJson(view.getHitTestResult()));
            //MLog.i(TAG, "mWebViewClient shouldOverrideUrlLoading:" + url);
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            MLog.d("mUrl:" + url + " onPageStarted  target:" + getUrl());
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (timer.get(url) != null) {
                ...
                MLog.d("  page mUrl:" + url + "  used time:" + (overTime - startTime));
            }
	   ...
	   /* public void onMainFrameError(AbsAgentWebUIController agentWebUIController, WebView view, int errorCode, String description, String failingUrl) {
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            ...
            //MLog.i(TAG, "onReceivedError:" + errorCode + "  description:" + description + "  errorResponse:" + failingUrl);
        }
    };
    ...
    protected MiddlewareWebClientBase getMiddlewareWebClient() {
        return this.mMiddleWareWebClient = new MiddlewareWebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                MLog.d(TAG, "MiddlewareWebClientBase#shouldOverrideUrlLoading url:" + url);
            ...
            @Override
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                //MLog.d(TAG, "MiddlewareWebClientBase#shouldOverrideUrlLoading request url:" + request.getUrl().toString());
                return super.shouldOverrideUrlLoading(view, request);
            }
