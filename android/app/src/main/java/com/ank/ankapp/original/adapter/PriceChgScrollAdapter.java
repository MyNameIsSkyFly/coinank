...
public class PriceChgScrollAdapter extends PanelAdapter {
    ...
    private static final int TITLE_COL_7 = 5;
    private static final int ROW_COL_7 = 6;
    ...
    public PriceChgScrollAdapter()
    {

    }

    public PriceChgScrollAdapter(Context cot, List<MarkerTickerVo> data)
    {
        this.data = data;
    }

    public PriceChgScrollAdapter(Context cot, List<MarkerTickerVo> data, List<String> titleList)
    {
        this.data = data;
    ...
    public int getItemViewType(int row, int column) {
        ...
        if (row == 0 && column == 7) return TITLE_COL_7;//最後一列要寬一點
        if (row > 0 && column == 7) return ROW_COL_7;//最后一列要宽一点
    ...
    private void setRowContent(ContentHolder holder, int row, int col)
    {
        ...
        else if (col == 3)
        {
            ...
            String s = AppUtils.getFormatStringValue(vo.priceChangeM5, 2) + "%";
            holder.tv_content.setText(s);
            if (vo.priceChangeM5 >= 0)
            {
        ...
        {
            String sLocal = LanguageUtil.getShortLanguageName(holder.itemView.getContext());
            String s = AppUtils.getFormatStringValue(vo.priceChangeM15, 2) + "%";
            holder.tv_content.setText(s);
            if (vo.priceChangeM15 >= 0)
            {
                holder.tv_content.setTextColor(Config.greenColor);
            }
            else
        ...
        {
            String sLocal = LanguageUtil.getShortLanguageName(holder.itemView.getContext());
            String s = AppUtils.getFormatStringValue(vo.priceChangeM30, 2) + "%";
            holder.tv_content.setText(s);
            if (vo.priceChangeM30 >= 0)
            {
                holder.tv_content.setTextColor(Config.greenColor);
            }
            else
        ...
        {
            String sLocal = LanguageUtil.getShortLanguageName(holder.itemView.getContext());
            String s = AppUtils.getFormatStringValue(vo.priceChangeH1, 2) + "%";
            holder.tv_content.setText(s);
            if (vo.priceChangeH1 >= 0)
            {
                holder.tv_content.setTextColor(Config.greenColor);
            }
            else
        ...
        {
            String sLocal = LanguageUtil.getShortLanguageName(holder.itemView.getContext());
            String s = AppUtils.getFormatStringValue(vo.priceChangeH4, 2) + "%";
            holder.tv_content.setText(s);
            if (vo.priceChangeH4 >= 0)
            {
                holder.tv_content.setTextColor(Config.greenColor);
            }
            else
        ...
        {
            String sLocal = LanguageUtil.getShortLanguageName(holder.itemView.getContext());
            String s = AppUtils.getFormatStringValue(vo.priceChangeH24, 2) + "%";

            holder.tv_content.setText(s);
            if (vo.priceChangeH24 >= 0)
            {
                holder.tv_content.setTextColor(Config.greenColor);
            }
            else
        ...
        switch (viewType) {
            ...
            case TITLE_WITH_SORT_TYPE:
                return new TitleWithSortHolder(LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.item_title_with_sort2, parent, false));
            case TITLE_COL_7:
                return new TitleWithSortHolder(LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.item_title_with_sort_last_col, parent, false));
            case ROW_COL_7:
                return new ContentHolder(LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.item_row_content_last_col, parent, false));
            default:
                break;
        }
