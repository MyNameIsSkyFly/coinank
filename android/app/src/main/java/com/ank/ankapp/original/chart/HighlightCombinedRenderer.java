            ...
            switch (order) {
                case BAR:
                    if (chart.getBarData() != null){
                        OffsetBarRenderer render = new OffsetBarRenderer(chart, mAnimator,
                                mViewPortHandler, Config.barOffset)
                                .setHighlightWidthSize(Config.highlightWidth, Config.highlightTextSize);
                        mRenderers.add(render);
