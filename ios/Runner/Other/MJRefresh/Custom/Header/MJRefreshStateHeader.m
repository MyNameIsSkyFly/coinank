...
- (void)textConfiguration {
    // 初始化文字
    [self setTitle:MyLocalized(@"s_refresh") forState:MJRefreshStateIdle];
    [self setTitle:MyLocalized(@"release_to_refresh") forState:MJRefreshStatePulling];
    [self setTitle:MyLocalized(@"refreshing") forState:MJRefreshStateRefreshing];
