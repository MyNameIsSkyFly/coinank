...
- (void)textConfiguration {
    // 初始化文字
    [self setTitle:MyLocalized(@"pull_up_to_load") forState:MJRefreshStateIdle];
    [self setTitle:MyLocalized(@"release_to_load") forState:MJRefreshStatePulling];
    [self setTitle:MyLocalized(@"loading") forState:MJRefreshStateRefreshing];
